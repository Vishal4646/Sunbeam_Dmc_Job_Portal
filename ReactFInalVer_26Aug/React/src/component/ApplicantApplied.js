...
export default function ApplicantApplied() {
  ...
  let shortList = (id) => {
    axios
      .post(constants.serverUrl+"/recruiter/shortlist", { job_applied_id: id })
      .then((res) => {
  ...
  return (
    < >
      {message === "" ? (
        ...
        <center>
             <div class="shadow p-3 mb-3 bg-body rounded" style={{maxWidth: 1000}}>APPLIED APPLICANT TO YOUR JOB POSTED</div>
        </center>
      <center>
        <div
