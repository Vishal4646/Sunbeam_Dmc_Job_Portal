...
public class Job implements Serializable {
    ...
    public Job(int job_id, int posted_by_id, String company_name, String job_type, String created_date, String job_description, Integer is_active, String skill_set_required, int position, String job_location) {
        this.job_id = job_id;
